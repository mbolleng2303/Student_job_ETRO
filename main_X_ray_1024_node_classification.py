    ...
    try:
        for split_number in range(4):
            ...
            if MODEL_NAME in ['RingGNN', '3WLGNN']:
                ...
                from train.train_X_ray_1024_node_classification import train_epoch_dense as train_epoch, \
                ...
                train_loader = DataLoader(trainset, shuffle=True,
                                          collate_fn=partial(dataset.collate_dense_gnn, pos_enc=net_params['pos_enc']))
                ...
                from train.train_X_ray_1024_node_classification import train_epoch_sparse as train_epoch, \
            ...
            with tqdm(range(params['epochs'])) as t:
                for epoch in t:
                    ...
                    if MODEL_NAME in ['RingGNN', '3WLGNN']:  # since different batch training function for dense GNNs
                        epoch_train_loss, epoch_train_acc, optimizer = train_epoch(model, optimizer, device,
                                                                                   train_loader, epoch,
                                                                                   params['batch_size'])
